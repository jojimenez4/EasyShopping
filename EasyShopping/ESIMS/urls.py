...
from .views import inventario, añadir_producto, eliminar_producto, editar_producto, pedidos_view,crear_categoria, crear_medida,generar_pedido,detalle_pedido_view, activar_producto
